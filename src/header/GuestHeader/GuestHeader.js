...
const GuestHeader = () => {
  ...
  return(
    <header className="nhsuk-header nhsuk-header--transactional" role="banner" data-testid="guest-header">
      <div className="nhsuk-width-container nhsuk-header__container">
        <div className="nhsuk-header__transactional-service-name deductions-header-container" >
